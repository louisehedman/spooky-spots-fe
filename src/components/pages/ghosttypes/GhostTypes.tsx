...
const GhostTypes: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return (
        <div className="container py-4 px-4 pt-4 text-white rounded text-center w-50" style={{backgroundColor: "#0e284a"}}>
        <h2 className="text-center my-4">Ghost Types</h2>
        <div className="d-flex row justify-content-between">
        {ghostTypes
          .map((ghostType: IGhostType, index: any) => {
            return (
                <div className="card border-0 col-lg-6" style={{backgroundColor: "#0e284a"}} key={index}>
                    <div className="card-header">{ghostType.type}</div>
                </div>
